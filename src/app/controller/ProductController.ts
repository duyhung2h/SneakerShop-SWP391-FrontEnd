...
export class ProductController {
     ...
     */
    loadProductFavorite() {
        this.favoriteProductService.getFavoriteProduct(this.authService.userModel.customer?.customerId).then(data => {
    ...
    addFavorite(product: any) {
        this.favoriteProductService.getFavoriteProduct(this.authService.userModel.customer?.customerId).then(data => {
            ...
            if (idIndex != -1) {
                ...
                this.favoriteProductService.removeFavoriteProduct(this.authService.userModel.customer?.customerId, product.product.productId).then(data => {
                ...
                this.favoriteProductService.addFavoriteProduct(this.authService.userModel.customer?.customerId, product.product.productId).then(data => {
